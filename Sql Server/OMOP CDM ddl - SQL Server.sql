...
CREATE TABLE genomic_single_nucleotide_variants (
  ...
  "hgvsp_db"          varchar(50),
  "dbsnp"             varchar(15),
  "t_total_depth"     INTEGER,
  "t_ref_depth"       INTEGER,
  "t_var_depth"       INTEGER,
  "n_total_depth"     INTEGER,
  "n_ref_depth"       INTEGER,
  "n_var_depth"       INTEGER,
  "allele_freq"       FLOAT,
  "strand"            varchar(10),
...
CREATE TABLE genomic_structural_variation (
  ...
  "gene1_concept_id" INTEGER,
  "gene2_concept_id" INTEGER,
  "nkmers"          INTEGER,
